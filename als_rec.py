...
spark-submit --driver-memory 16G als_rec.py data/parquets/train_pct_100.parquet data/parquets/val_pct_100.parquet pct_100_als_model.parquet
...
def main(spark, filename_train, filename_test, filename_output):
    ...
    for rank in ranks:
        for regParam in regParams:
            ...
            if best_mapAtk == None or test_mapAtk > best_mapAtk:
                print(test_mapAtk)
                best_rank = rank
                best_regParam = regParam
                best_mapAtk = test_mapAtk
                best_model = model
